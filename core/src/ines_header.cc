...
[[nodiscard]]
bool INESHeader::HasValidMagic() const noexcept {
  return magic_[0] == 0x4E && magic_[1] == 0x45 && magic_[2] == 0x53 && magic_[3] == 0x1A;
}

[[nodiscard]]
std::size_t INESHeader::SizeOfPRGRom() const noexcept {
  return prg_rom_size_ * INESHeader::k16kb;
}

[[nodiscard]]
std::size_t INESHeader::SizeOfCHRRom() const noexcept {
  return chr_rom_size_ * INESHeader::k8kb;
}
...
[[nodiscard]]
std::size_t INESHeader::SizeOfPRGRam() const noexcept {
  return prg_ram_size_ * INESHeader::k8kb;
}
